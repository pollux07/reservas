...
use Reservas\Bundle\ReservasBundle\Entity\pais;
use Reservas\Bundle\ReservasBundle\Form\paisType;
...
class paisController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ReservasReservasBundle:pais')->findAll();

        return $this->render('ReservasReservasBundle:pais:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('ReservasReservasBundle:pais:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ReservasReservasBundle:pais')->find($id);
        ...
        return $this->render('ReservasReservasBundle:pais:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('ReservasReservasBundle:pais:edit.html.twig', array(
            'entity'      => $entity,
