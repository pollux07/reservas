...
use Reservas\Bundle\ReservasBundle\Entity\estado;
use Reservas\Bundle\ReservasBundle\Form\estadoType;
...
class estadoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ReservasReservasBundle:estado')->findAll();

        return $this->render('ReservasReservasBundle:estado:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('ReservasReservasBundle:estado:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ReservasReservasBundle:estado')->find($id);
        ...
        return $this->render('ReservasReservasBundle:estado:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('ReservasReservasBundle:estado:edit.html.twig', array(
            'entity'      => $entity,
